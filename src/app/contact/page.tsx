...
const ContactLayout = () => {
  return (
    <>
      ...
      <div className="absolute top-[calc(50dvh-10rem)] right-[calc(max(60vw/3,960vh/27)-min(30vw,12rem))] w-[min(60vw,24rem)] h-[30rem] -z-2 contact-open contact">
      ...
      <div className="absolute top-[calc(50dvh+12.5rem+max(0.5625vw,1vh))] right-[calc(max(60vw/3,960vh/27)-2px)] w-1 h-[calc(max(21.375vw,38dvh)-12.5rem)] bg-white opacity-75 contact-indicator animate-[1s_ease-in-out_wipe-up] -z-2" />
    </>
  );
};
