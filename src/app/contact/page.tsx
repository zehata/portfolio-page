...
const ContactLayout = () => {
  return (
    <>
      ...
      <div className="fixed top-[calc(50vh-15rem)] right-[calc(max(60vw/3,960vh/27)-min(30vw,12rem))] w-[min(60vw,24rem)] h-[30rem] -z-2 contact-open contact">
      ...
      <div className="absolute top-[calc(50vh+7.5rem+max(0.5625vw,1vh))] right-[calc(max(60vw/3,960vh/27)-2px)] w-1 h-[calc(50vh-7.5rem-max(6.1875vw,11vh))] bg-white opacity-75 contact-indicator animate-[1s_ease-in-out_wipe-up] -z-2" />
    </>
  );
};
