...
export const DynamicBackground = ({
  ...
  return (
    <div className="w-[max(100vw,160vh)] h-[max(100vh,62.5vw)] dynamic-background animate-[2s_ease_delayed-fade-in]">
      <div
        className={classNames(
          "absolute w-[max(100vw,160vh)] h-[max(100vh,62.5vw)] bg-cover",
          {
            ["top-0 left-0"]: backgrounds[name].align === "top left",
            ["bottom-0 left-[calc(50vw-max(50vw,80vh))]"]:
              backgrounds[name].align === "bottom",
          },
        )}
        style={{
      ...
      ></div>
      {backgrounds[name].label && (
        <img
          className="absolute w-[max(10vw,16vh)] top-[max(8vh,5vw)] left-[max(5vw,8vh)] transform-[matrix3d(1.6945,-0.5087,1.2874,0.001,1.3841,1.038,-0.9336,0.001,0.0255,1.5901,1.3115,0,0,0,0,1)]"
          src={backgrounds[name].label}
          alt=""
        />
      )}
